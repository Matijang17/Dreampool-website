...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://dreampool.si/hidroizolacija/rezervoarji' },
}
...
const schema = {
  ...
  areaServed: 'Slovenia',
  description: 'Hidroizolacija vodnih rezervoarjev, cistern in zadrževalnikov v Sloveniji.',
}
