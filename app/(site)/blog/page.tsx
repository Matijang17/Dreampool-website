...
const staticPosts = [
  { _id: '1', title: 'Koliko stane bazen v Sloveniji 2026?', excerpt: 'Celovit vodič po cenah gradnje bazenov — vkopani in betonski, z vsemi skritimi stroški.', slug: { current: 'koliko-stane-bazen-slovenija-2026' }, publishedAt: '2026-01-15', mainImage: { asset: { url: '/images/Marezige/marezige_bazen-1.webp' } } },
  { _id: '2', title: 'Vkopani bazen: vodič po izbiri prave oblike', excerpt: 'Pravokotni, ovalni ali atipični — kako izbrati obliko vkopanega bazena, ki najbolj ustreza vašemu vrtu.', slug: { current: 'vkopani-bazen-izbira-oblike' }, publishedAt: '2026-01-05', mainImage: { asset: { url: '/images/bazen-kontakt.webp' } } },
  { _id: '3', title: 'Ali potrebujem gradbeno dovoljenje za bazen?', excerpt: 'Pravila za gradnjo bazenov v Sloveniji — kdaj potrebujete dovoljenje in kdaj ne.', slug: { current: 'gradbeno-dovoljenje-bazen-slovenija' }, publishedAt: '2025-12-20', mainImage: { asset: { url: '/images/hidroizolacija-s-folijo-1.webp' } } },
  { _id: '4', title: 'Ogrevanje bazena: stroški in možnosti', excerpt: 'Toplotne črpalke, solarni sistemi ali električni grelci — kaj je ekonomično in zakaj.', slug: { current: 'ogrevanje-bazena-stroski' }, publishedAt: '2025-12-01', mainImage: { asset: { url: '/images/vzdrzevanje-bazena.webp' } } },
]
