...
const staticPosts = [
  { _id: '1', title: 'Koliko stane bazen v Sloveniji 2026?', excerpt: 'Celovit vodič po cenah gradnje bazenov — od fiberglass do betonskih, z vsemi skritimi stroški.', slug: { current: 'koliko-stane-bazen-slovenija-2026' }, publishedAt: '2026-01-15', mainImage: { asset: { url: 'https://cdn.sanity.io/images/u77huvva/production/6da0045ebc99873dd993284fa370bc86a4dc51fa-5120x2880.jpg?w=800&fit=max&auto=format' } } },
  { _id: '2', title: 'Fiberglass ali beton: kateri bazen izbrati?', excerpt: 'Primerjava prednosti in slabosti obeh materialov, ki vam bo pomagala sprejeti pravo odločitev.', slug: { current: 'fiberglass-ali-beton-bazen' }, publishedAt: '2026-01-05', mainImage: { asset: { url: 'https://cdn.sanity.io/images/u77huvva/production/7ee2f8ad2f09fc39781fb51d3857c7613b4f66f7-5120x2880.jpg?w=800&fit=max&auto=format' } } },
